...
namespace Microsoft.Psi.TeamsBot
{
    ...
    public class Program
    {
        ...
        private static PsiImporter OpenStore(Pipeline pipeline)
        {
            ...
            return PsiStore.Open(pipeline, "CallStore_601f5c00-f1fc-4250-a4d6-aeb3b4db4cad", @"C:\Users\robbi\microsoft-graph-comms-samples\Samples\PublicSamples\PsiBot\recordings\");
        }
